...
Email [founders@anarlog.so](mailto:founders@anarlog.so) with those details and any in-app log entries. If the log is empty, include the native `app.log` from the affected computer. For the stable desktop app:
