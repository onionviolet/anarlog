...
Enables the recording_safety_status command without any pre-configured scope.
...
`transcription:deny-recording-safety-status`

</td>
<td>

Denies the recording_safety_status command without any pre-configured scope.
