...
Delete your account yourself from the Account page in the web app (`anarlog.so/app/account`), or email us at team@fastrepl.com and we'll do it. Your local data stays on your device — account deletion doesn't touch it.
...
Questions about this policy? Email us at [team@fastrepl.com](mailto:team@fastrepl.com).
