...
Delete your account anytime from the Account page in the web app (`anarlog.so/app/account`), or email us at team@fastrepl.com. We remove your cloud-stored data within 30 days. Your local data stays on your device, and Anarlog keeps working in local-only mode.
...
Opt out of marketing anytime via the unsubscribe link in any marketing email, or by emailing team@fastrepl.com. Opting out doesn't affect transactional or service messages.
...
Questions about these terms? Email us at [team@fastrepl.com](mailto:team@fastrepl.com).
